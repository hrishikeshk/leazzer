...
<div class="inner-block">
    <div class="blank">
    	<div class="blankpage-main" style="padding:1em 1em;">
    			<?php 
							$res = mysqli_query($conn,"select * from reserve where cid=".$_SESSION['lcdata']['id']." order by reservefromdate desc limit 100");
							...
							{
								echo "<tr>\n";
								echo "<td>".date("d/m/Y",$arr['reservefromdate'])." - ".date("d/j/Y",$arr['reservetodate'])."</td>\n";
								$resF = mysqli_query($conn,"select * from facility where id=".$arr['fid']);
								$arrF = mysqli_fetch_array($resF,MYSQLI_ASSOC);
								echo "<td>".$arrF['companyname']."</td>\n";
