...
function ajaxcall_self(form, datastring){
    ...
    ({	
    		...
    		success: function(result){		
   				 	res = result;
   				 	form.querySelector("message").innerText = '<b>Succesfully saved your credit card details.</b>';
   		 	},
   		 	error: function(err){
    	...
    	<div class="blankpage-main">
    		<center>
    			...
    			<hr>
					...
					?>
					<center><img src="../images/emsurvey2.png" /><img src="../images/shield.jpg" height="17%" width="17%" /></center>
