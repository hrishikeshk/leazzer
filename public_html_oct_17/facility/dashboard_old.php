...
if(isset($_POST['submit']))
{
	if($_POST['submit'] == "Save")
	{
		...
		if(isset($_FILES["image"]))
		{
			...
			{
				$imageFileName = $ts."_img.".$file['extension'];
    		...
    		<div class="col-md-4" style="border:0px solid #000;padding:0px 5px;margin:0;">
    				...
    				<hr style="margin:5px 0px 5px 0px">
    					<?php 
    						...
    						?>
    				<div class="fileUpload btn btn-primary"><span>Choose Image</span><input type="file" class="upload" name="image"/>
					</div>
					...
					Receive Reservations at <input type="text" name="emailid" placeholder="Email address to receive Reservation Confirmations" value="<?php echo $arrF['emailid'];?>" required="" class="form-control" style="margin-bottom:5px;width:50%;display:inline;"><br>
    				...
    				<input type="checkbox" name="receivereserve" style="margin-bottom:5px;display:inline;" <?php echo ($arrF['receivereserve']==1?"checked":"");?>> We Want To Receive Text For Reservation<br>
    			</div>
