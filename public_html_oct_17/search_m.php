				...
				<div class="header-main">
					<div class="header-left" style="width:100%;">
							<div class="logo-name login-block"  style="width:100%;padding:0;margin:0;">
								<form method="post" action="search_m.php" enctype="multipart/form-data">
								<center>
			   ...
			   if(isset($_SESSION['filter'])){
			   		...
			   		for($i=0;$i<count($filter_vals);$i++){
			   			echo '<div style="background:#eee;display:inline-block;padding:5px;margin:2px;">'.
			   						$filter_vals[$i].
			   						' <a href="search_m.php?action=removefilter&id='.htmlspecialchars($_SESSION['filter'][$i], ENT_QUOTES).'" style="color:#68AE00;"><i class="fa fa-close"></i></a></div>';
