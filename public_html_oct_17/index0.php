...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <h1><a class="navbar-brand" href="#"><img src="images/llogo.png" height=120px></a></h1>
    </div>
...
<h2>Your One Stop Shop For Storage</h2>
...
<div class="w3l_banser">
	<div id="search_form" class="search_top">
		...
		<input class="text" name="search" type="text" placeholder="Zip or Address" required="">
			...
			<br><a href="helpmechoose.php" style="color:#000;text-shadow: 1px 1px 1px #555;">Help me choose units</a>
			<div class="clearfix"></div>
		</form>
	</div>
	</div>
